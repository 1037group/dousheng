...
func (p *ApiServiceClient) RelationFollowerList(ctx context.Context, req *RelationFollowerListRequest) (r *RelationFollowerListResponse, err error) {
...
var ApiServiceRelationFollowerListArgs_Req_DEFAULT *RelationFollowerListRequest

func (p *ApiServiceRelationFollowerListArgs) GetReq() (v *RelationFollowerListRequest) {
	if !p.IsSetReq() {
...
var ApiServiceRelationFollowerListResult_Success_DEFAULT *RelationFollowerListResponse

func (p *ApiServiceRelationFollowerListResult) GetSuccess() (v *RelationFollowerListResponse) {
	if !p.IsSetSuccess() {
