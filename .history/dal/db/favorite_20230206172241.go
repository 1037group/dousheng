...
func UpdateFavorite(ctx context.Context, tx *gorm.DB, user_id *int64, video_id *int64) error {
	klog.CtxInfof(ctx, "[db.UpdateFavorite] userId: %+v, toUserId: %+v, actionType: %+v", userId, toUserId, actionType)
	return nil
}
