...
func MGetIsFavoriteByUserId(ctx context.Context, tx *gorm.DB, user_id *int64, video_id *int64) ([]*sql.Favorite, error) {
	klog.CtxInfof(ctx, "[MGetIsFavoriteByUserId] user_id: %+v\n", user_id)
...
func CancelFavorite(ctx context.Context, favor *sql.Favorite, user_id int64, video_id int64) error {
