...
func Video(m *sql.Video, n *douyin_user.User, m_isfavorite int32) *douyin_feed.Video {
	if m == nil {
		return nil
	}
	var isfavorite bool
...
func Videos(ms []*sql.Video, ns map[int64]douyin_user.User, isfavorite []int32) []*douyin_feed.Video {
