...
func Video(m *sql.Video, n *douyin_user.User, isfavorite bool) *douyin_feed.Video {
	if m == nil {
		return nil
	}
...
func Videos(ms []*sql.Video, ns map[int64]douyin_user.User, isfavorite []bool) []*douyin_feed.Video {
