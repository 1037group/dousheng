...
type Favorite struct {
	...
	IsFavorite int8      `gorm:"column:isfavorite" db:"isfavorite" json:"isfavorite" form:"isfavorite"`
	DelState   int8      `gorm:"column:delstate" db:"delstate" json:"delstate" form:"delstate"`
