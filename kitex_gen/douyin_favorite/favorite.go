...
func (p *FavoriteListResponse) GetVideoList() (v []*douyin_feed.Video) {
	return p.VideoList
}
...
func (p *FavoriteListResponse) SetVideoList(val []*douyin_feed.Video) {
	p.VideoList = val
}
...
func (p *FavoriteListResponse) Field3DeepEqual(src []*douyin_feed.Video) bool {
