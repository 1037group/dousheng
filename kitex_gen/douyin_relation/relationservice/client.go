...
func (p *kRelationServiceClient) RelationAction(ctx context.Context, req *douyin_relation.RelationActionRequest, callOptions ...callopt.Option) (r *douyin_relation.RelationActionResponse, err error) {
