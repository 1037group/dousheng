...
type Video struct {
	...
	Author        *douyin_user.User `thrift:"author,2,required" frugal:"2,required,douyin_user.User" json:"author"`
...
var Video_Author_DEFAULT *douyin_user.User

func (p *Video) GetAuthor() (v *douyin_user.User) {
	if !p.IsSetAuthor() {
...
func (p *Video) SetAuthor(val *douyin_user.User) {
	p.Author = val
}
...
func (p *Video) Field2DeepEqual(src *douyin_user.User) bool {
