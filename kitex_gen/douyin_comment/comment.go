...
type Comment struct {
	...
	User       *douyin_user.User `thrift:"user,2,required" frugal:"2,required,douyin_user.User" json:"user"`
...
var Comment_User_DEFAULT *douyin_user.User

func (p *Comment) GetUser() (v *douyin_user.User) {
	if !p.IsSetUser() {
...
func (p *Comment) SetUser(val *douyin_user.User) {
	p.User = val
}
...
func (p *Comment) Field2DeepEqual(src *douyin_user.User) bool {
